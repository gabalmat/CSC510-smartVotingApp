...
/**
 * Tests for {@link SmartVotingController}. Modify the tests in order to support your use case as you build your project.
 */
@DisplayName("Tests for HelloWorldController")
public class SmartVotingControllerTest {

    private static final String EXPECTED_SITE_NAME = "home";
    private static final String EXPECTED_VIEW_NAME = "index";

    private SmartVotingController smartVotingController = new SmartVotingController(EXPECTED_SITE_NAME);
    ...
    /**
     * Basic test to verify the result obtained when calling {@link SmartVotingController#helloWorld} successfully.
     */
    @Test
